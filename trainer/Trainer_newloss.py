...
from . import interactive_trainer_utils as Mutils        
...
class Trainer_cubic_weighted_loss(nnUNetTrainer_interactive.nnUNetTrainerinteractive):
    ...
    note : click simulation is force to be redesign to get a list of all the clicks ..."""
    ...
    def _build_loss(self,):
        ...
        loss = Mutils.cubic_loss({'batch_dice': self.configuration_manager.batch_dice,
                                   'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, {'ignore_index':self.label_manager.ignore_label if self.label_manager.ignore_label is not None else -100}, weight_ce=1, weight_dice=1,
